    ...
    <el-dialog title="Schedule Log Detail" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="Exception:" v-if="form.status == 1">{{ form.exceptionInfo }}</el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure you want to delete log #' + jobLogIds + '?').then(function() {
    ...
    /** Clear handler */
    handleClean() {
      this.$modal.confirm('Are you sure you want to clear all schedule logs?').then(function() {
        return cleanJobLog();
      }).then(() => {
        this.getList();
