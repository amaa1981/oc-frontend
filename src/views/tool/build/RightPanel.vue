<template>
  <div class="right-board">
    <el-tabs v-model="currentTab" class="center-tabs">
      <el-tab-pane label="Component Props" name="field" />
      <el-tab-pane label="Form Props" name="form" />
    </el-tabs>
    <div class="field-box">
      <a class="document-link" target="_blank" :href="documentLink" title="View component docs">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          <el-form-item v-if="activeData.changeTag" label="Component Type">
            <el-select
              ...
              placeholder="Please selectComponent Type"
              :style="{width: '100%'}"
              @change="tagChange"
            >
          ...
          <el-form-item v-if="activeData['start-placeholder']!==undefined" label="Start Placeholder">
            <el-input v-model="activeData['start-placeholder']" placeholder="Please enter Placeholder" />
          </el-form-item>
          <el-form-item v-if="activeData['end-placeholder']!==undefined" label="End Placeholder">
            <el-input v-model="activeData['end-placeholder']" placeholder="Please enter Placeholder" />
          </el-form-item>
          <el-form-item v-if="activeData.span!==undefined" label="Form Grid Span">
            <el-slider v-model="activeData.span" :max="24" :min="1" :marks="{12:''}" @change="spanChange" />
          </el-form-item>
          <el-form-item v-if="activeData.layout==='rowFormItem'" label="Gutter">
            <el-input-number v-model="activeData.gutter" :min="0" placeholder="Gutter" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.justify!==undefined&&activeData.type==='flex'" label="Horizontal Align">
            <el-select v-model="activeData.justify" placeholder="Please selectHorizontal Align" :style="{width: '100%'}">
              <el-option
          ...
          <el-form-item v-if="activeData.align!==undefined&&activeData.type==='flex'" label="Vertical Align">
          ...
          <el-form-item v-if="activeData.tag==='el-checkbox-group'" label="Min Selected">
            <el-input-number
          ...
          <el-form-item v-if="activeData.tag==='el-checkbox-group'" label="Max Selected">
            <el-input-number
          ...
          <el-form-item v-if="activeData['prefix-icon']!==undefined" label="Prefix Icon">
            <el-input v-model="activeData['prefix-icon']" placeholder="Please enter the Prefix Icon name">
          ...
          <el-form-item v-if="activeData.maxlength !== undefined" label="Max Length">
            <el-input v-model="activeData.maxlength" placeholder="Please enter max length">
          ...
          <el-form-item v-if="activeData['active-text'] !== undefined" label="Active Text">
            <el-input v-model="activeData['active-text']" placeholder="Please enter Active Text" />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-text'] !== undefined" label="Inactive Text">
            <el-input v-model="activeData['inactive-text']" placeholder="Please enter Inactive Text" />
          </el-form-item>
          <el-form-item v-if="activeData['active-value'] !== undefined" label="Active Value">
            <el-input
              :value="setDefaultValue(activeData['active-value'])"
              placeholder="Please enter Active Value"
          ...
          <el-form-item v-if="activeData['inactive-value'] !== undefined" label="Inactive Value">
            <el-input
              ...
              placeholder="Please enter Inactive Value"
          ...
          >
            <el-select
              ...
              placeholder="Please selectTime Type"
              :style="{ width: '100%' }"
          ...
          <el-form-item v-if="activeData.name !== undefined" label="documentField Name">
          ...
          <el-form-item v-if="activeData.accept !== undefined" label="File Type">
            <el-select
              ...
              placeholder="Please selectFile Type"
              :style="{ width: '100%' }"
              clearable
            >
          ...
          <el-form-item v-if="activeData.action !== undefined" label="Upload URL">
            <el-input v-model="activeData.action" placeholder="Please enter Upload URL" clearable />
          </el-form-item>
          ...
          <template v-if="['el-checkbox-group', 'el-radio-group', 'el-select'].indexOf(activeData.tag) > -1">
            ...
            >
              <div v-for="(item, index) in activeData.options" :key="index" class="select-item">
                ...
                <el-input v-model="item.label" placeholder="Option Label" size="small" />
                <el-input
          ...
          <el-form-item v-if="activeData.tag === 'el-color-picker'" label="Color Format">
            <el-select
              ...
              placeholder="Please selectColor Format"
              :style="{ width: '100%' }"
          ...
          <el-form-item v-if="activeData.tag === 'el-input-number'" label="strictStep count">
            <el-switch v-model="activeData['step-strictly']" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="Multiple">
            <el-switch v-model="activeData.props.props.multiple" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="Show All Levels">
          ...
          <el-form-item v-if="activeData.tag === 'el-select'" label="Filterable">
            <el-switch v-model="activeData.filterable" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-select'" label="Multiple">
          ...
          <template v-if="activeData.layout === 'colFormItem' && activeData.tag !== 'el-button'">
            <el-divider>Regex Rules</el-divider>
            <div
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          <el-form-item label="Form Ref">
            <el-input v-model="formConf.formRef" placeholder="Please enter Form Ref (ref)" />
          </el-form-item>
          <el-form-item label="Form Model">
            <el-input v-model="formConf.formModel" placeholder="Please enter form model" />
          </el-form-item>
          <el-form-item label="Rules Model">
            <el-input v-model="formConf.formRules" placeholder="Please enter Rules Model" />
          </el-form-item>
          ...
          <el-form-item label="Label Align">
          ...
          <el-form-item label="Gutter">
            <el-input-number v-model="formConf.gutter" :min="0" placeholder="Gutter" />
          </el-form-item>
          <el-form-item label="DisableForm">
            <el-switch v-model="formConf.disabled" />
          </el-form-item>
          <el-form-item label="Formbutton">
    ...
    <treeNode-dialog :visible.sync="dialogVisible" title="Add toOptions" @commit="addNode" />
...
export default {
  ...
  data() {
    return {
      ...
      dateRangeTypeOptions: [
        ...
        {
          label: "datetimerange(datetimerange)",
          value: 'datetimerange'
        }
      ],
      colorFormatOptions: [
  ...
  methods: {
    ...
    colorFormatChange(val) {
      ...
      this.activeData.renderKey = +new Date() // renewrenderKey,Re-render the component
    },
