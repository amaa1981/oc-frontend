    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="Column Info" name="columnInfo">
        <el-table ref="dragTable" :data="columns" row-key="columnId" :max-height="tableHeight">
          ...
          <el-table-column label="HTML Type" min-width="12%">
            <template slot-scope="scope">
      ...
      <el-tab-pane label="Generator Info" name="genInfo">
...
export default {
  ...
  created() {
    ...
    if (tableId) {
      ...
      /** QueryDictionary drop downList */
      getDictOptionselect().then(response => {
        this.dictOptions = response.data;
      });
      /** Querymenu drop downList */
    ...
    submitForm() {
      ...
      Promise.all([basicForm, genForm].map(this.getFormPromise)).then(res => {
        ...
        if (validateResult) {
          ...
          this.$modal.msgError("FormVerification failed，Please recheckSubmitcontent");
        }
      });
    },
    getFormPromise(form) {
