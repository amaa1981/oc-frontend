 ...
 * @LastEditTime: 2025-08-08 09:53:26
 * @LastEditors: FGJ
...
<template>
  <div class="right-container">
    ...
    <div class="chart-header">
      ...
      <span class="chart-header__sub">{{ $t('dataCenter.eventAlarmTrend') }}</span>
    </div>
    <!-- 表格 -->
  ...
  methods: {
    ...
    handleChartClick(params) {
      ...
      if (this.data[0].week.length === 7) {
        ...
        const day = today.getDay() || 7; // Get current day (0-6, 0=Sunday)
