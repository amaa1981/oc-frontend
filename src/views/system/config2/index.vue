  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="Built-in" prop="configType">
        <el-select v-model="queryParams.configType" placeholder="Select type" clearable>
          <el-option
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="Config Name" prop="configName">
          <el-input v-model="form.configName" placeholder="Enter config name" />
        </el-form-item>
        <el-form-item label="Config Key" prop="configKey">
          <el-input v-model="form.configKey" placeholder="Enter config key" />
        </el-form-item>
        <el-form-item label="Config Value" prop="configValue">
          <el-input v-model="form.configValue" placeholder="Enter config value" />
        </el-form-item>
        <el-form-item label="Built-in" prop="configType">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        configKey: [
          { required: true, message: "Config key is required", trigger: "blur" }
        ],
        configValue: [
          { required: true, message: "Config value is required", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure you want to delete config #' + configIds + '?').then(function() {
