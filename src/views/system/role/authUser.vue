  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        ...
        >{{ $t('role.cancelAuthUserAll') }}</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          type="warning"
      ...
      <el-table-column :label="$t('commonBtn.operate')" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:role:remove']"
          >{{ $t('role.cancelAuthUser') }}</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    cancelAuthUserAll(row) {
      ...
      this.$modal.confirm(this.$t('role.confirmRemoveAuthAll')).then(function() {
