<template>
  <div class="app-container">
    <el-form
      ...
      v-show="showSearch"
    >
      <el-form-item :label="$t('area.deptName')" prop="deptName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          >{{ $t("area.toggleExpandAll") }}</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      <el-table-column
        prop="deptName"
        :label="$t('area.deptName')"
        width="260"
      ></el-table-column>
      <el-table-column
        prop="orderNum"
        :label="$t('area.orderNum')"
        width="200"
      ></el-table-column>
      <el-table-column prop="status" :label="$t('area.status')" width="180">
        <template slot-scope="scope">
          {{ $t("dict.sys_normal_disable." + scope.row.status) }}
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('area.createTime')"
        align="center"
        prop="createTime"
        width="200"
      >
    ...
    <!-- Add or Edit Device Zone Dialog Box -->
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-position="top">
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item :label="$t('area.parentId')" prop="parentId">
              <treeselect
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$t('area.orderNum')" prop="orderNum">
              <el-input-number
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('area.leader')" prop="leader">
              <el-input
                v-model="form.leader"
                :placeholder="$t('commonTips.pleaseEnter')"
                maxlength="20"
          ...
          <el-col :span="12">
            <el-form-item :label="$t('area.phone')" prop="phone">
              <el-input
                v-model="form.phone"
                :placeholder="$t('commonTips.pleaseEnter')"
                maxlength="11"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('area.email')" prop="email">
              <el-input
                v-model="form.email"
                :placeholder="$t('commonTips.pleaseEnter')"
                maxlength="50"
          ...
          <el-col :span="12">
            <el-form-item :label="$t('area.status')">
...
export default {
  ...
  methods: {
    ...
    handleAdd(row) {
      ...
      this.open = true;
      this.title = this.$t("area.dialogTitle_a");
    ...
    handleUpdate(row) {
      ...
      getDept(row.deptId).then((response) => {
        ...
        this.open = true;
        this.title = this.$t("area.dialogTitle_e");
    ...
    handleDelete(row) {
      this.$modal
        .confirm(this.$t("area.confirmRemove", { deptName: row.deptName }))
        .then(function () {
