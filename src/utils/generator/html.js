...
// If the span is not 24, wrap it with el-col.
...
function buildElUploadChild(conf) {
  ...
  if (conf.showTip) list.push(`<div slot="tip" class="el-upload__tip">Can only upload no more than ${conf.fileSize}${conf.sizeUnit} of${conf.accept}document</div>`)
  return list.join('\n')
}
