	...
	<el-form size='small'>
		...
		<el-form-item>
			<el-radio v-model='radioValue' :label="3">
				From
				<el-input-number v-model='average01' :min="1" :max="11" /> months, every
				<el-input-number v-model='average02' :min="1" :max="12 - average01 || 0" /> months execute once
			</el-radio>
		</el-form-item>
